...
/* ═══════════════════════════════════════════════════════
   LifeTrack MVP — v8  ·  BINARY
   Tap card = done ✓ / not done —
   No sliders. No scores. Just did you do it?
   ═══════════════════════════════════════════════════════ */
...
function MonthView({year,month,setMonth,hid,goWeek}){
  ...
  return(<div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
      <SC label="Лучшая серия" value={best} unit="дней" color={C.green}/><SC label="Текущая серия" value={cur} unit="дней" color={C.green}/>
    </div>
  </div>);
}
